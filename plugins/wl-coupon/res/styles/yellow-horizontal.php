...
screenshot: yellow-horizontal.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded drop-shadow wc-horizontal wc-gradient wc-yellow">
	<div class="wc-body">
		<p class="wc-alert">
...
/*YELLOW*/
#wl-coupons.wc-horizontal.wc-yellow .wc-label { color: #f39c12;}
#wl-coupons.wc-horizontal.wc-yellow { border-top: 2px solid #f39c12;}
