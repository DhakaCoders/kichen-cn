<!--
name: Red Horizontal
screenshot: red-horizontal.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded drop-shadow wc-horizontal wc-gradient wc-red">
	<div class="wc-body">
		<p class="wc-alert">
...
/*RED*/
#wl-coupons.wc-horizontal.wc-red .wc-label { color: #c0392b;}
#wl-coupons.wc-horizontal.wc-red { border-top: 2px solid #c0392b;}
