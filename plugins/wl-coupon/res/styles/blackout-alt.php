<!--
name: Blackout Alternative
screenshot: blackout-alt.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded wc-alt wc-gradient wc-bo">
	<div class="wc-body">
		<p class="wc-alert">
...
#wl-coupons.wc-bo .wc-label {
	background: #7f8c8d;
}

#wl-coupons.wc-bo .wc-body {}

#wl-coupons.wc-bo .wc-alert {}

#wl-coupons.wc-bo .wc-form {}

#wl-coupons.wc-bo .wishlist-coupon-code {}

#wl-coupons.wc-bo .wishlist-coupon-btn-apply {
	background: #7f8c8d;
}

#wl-coupons.wc-bo .wc-footer {}

#wl-coupons.wc-bo .wishlist-coupon-btn-pay {
	background: #7f8c8d;
}
...
/*GREY*/
#wl-coupons.wc-bo.wc-gradient .wc-label,
#wl-coupons.wc-bo.wc-gradient .wishlist-coupon-btn-pay,
#wl-coupons.wc-bo.wc-gradient .wishlist-coupon-btn-apply {
...
#wl-coupons.wc-bo.wc-gradient .wishlist-coupon-btn-pay {
	box-shadow: 0 1px 1px 0 #757575 inset;
	-webkit-box-shadow: 0 1px 1px 0 #757575 inset;
	border: 1px solid #7f8c8d;
	height: auto;
	padding: 15px;
}
#wl-coupons.wc-bo.wc-gradient .wishlist-coupon-btn-pay:hover,
#wl-coupons.wc-bo.wc-gradient .wishlist-coupon-btn-apply:hover {
	background: #000;
}
...
/*GREY*/
#wl-coupons.wc-horizontal.wc-bo .wc-label,
#wl-coupons.wc-alt.wc-bo .wc-label { color: #fff;}
#wl-coupons.wc-horizontal.wc-bo,
#wl-coupons.wc-alt.wc-bo { border-top: 2px solid #000;}
