<!--
name: Midnight Horizontal
screenshot: midnight-horizontal.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded drop-shadow wc-horizontal wc-gradient wc-mn">
	<div class="wc-body">
		<p class="wc-alert">
...
#wl-coupons.wc-mn .wc-label {
	background: #2980b9;
	color: #d4d8dc;
}

#wl-coupons.wc-mn .wc-body {
	border-bottom: 1px solid #000;
}

#wl-coupons.wc-mn .wc-alert {}

#wl-coupons.wc-mn .wc-form {}

#wl-coupons.wc-mn .wishlist-coupon-code {}

#wl-coupons.wc-mn .wishlist-coupon-btn-apply {
	color: #d4d8dc;
}

#wl-coupons.wc-mn .wc-footer {
	border-top: 1px solid #555;
}

#wl-coupons.wc-mn .wishlist-coupon-btn-pay {
	background: #2980b9;
	color: #d4d8dc;
}
...
/*MIDNIGHT*/
#wl-coupons.wc-mn.wc-gradient .wc-label,
#wl-coupons.wc-mn.wc-gradient .wishlist-coupon-btn-pay,
#wl-coupons.wc-mn.wc-gradient .wishlist-coupon-btn-apply {
	background: rgb(52,73,94); /* Old browsers */
	/* IE9 SVG, needs conditional override of 'filter' to 'none' */
	background: url(data:image/svg+xml;base64,);
	background: -moz-linear-gradient(top,  rgba(52,73,94,1) 0%, rgba(44,62,80,1) 100%); /* FF3.6+ */
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,rgba(52,73,94,1)), color-stop(100%,rgba(44,62,80,1))); /* Chrome,Safari4+ */
	background: -webkit-linear-gradient(top,  rgba(52,73,94,1) 0%,rgba(44,62,80,1) 100%); /* Chrome10+,Safari5.1+ */
	background: -o-linear-gradient(top,  rgba(52,73,94,1) 0%,rgba(44,62,80,1) 100%); /* Opera 11.10+ */
	background: -ms-linear-gradient(top,  rgba(52,73,94,1) 0%,rgba(44,62,80,1) 100%); /* IE10+ */
	background: linear-gradient(to bottom,  rgba(52,73,94,1) 0%,rgba(44,62,80,1) 100%); /* W3C */
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#34495e', endColorstr='#2c3e50',GradientType=0 ); /* IE6-8 */
}

#wl-coupons.wc-mn.wc-gradient .wishlist-coupon-btn-pay {
	box-shadow: 0 1px 1px 0 #4f6173 inset;
	-webkit-box-shadow: 0 1px 1px 0 #4f6173 inset;
	border: 1px solid #000;
}

#wl-coupons.wc-mn.wc-gradient .wishlist-coupon-btn-pay:hover,
#wl-coupons.wc-mn.wc-gradient .wishlist-coupon-btn-apply:hover {
	background: #2c3e50;
}
...
/*MIDNIGHT*/
#wl-coupons.wc-horizontal.wc-mn { border-top: 2px solid #7f8c8d; border-bottom: none;}
