<!--
name: Orange Horizontal
screenshot: orange-horizontal.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded drop-shadow wc-horizontal wc-gradient wc-orange">
	<div class="wc-body">
		<p class="wc-alert">
...
/*ORANGE*/
#wl-coupons.wc-horizontal.wc-orange .wc-label { color: #d35400;}
#wl-coupons.wc-horizontal.wc-orange { border-top: 2px solid #d35400;}
