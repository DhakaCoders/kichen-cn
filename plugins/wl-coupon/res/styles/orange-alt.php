...
screenshot: orange-alt.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded wc-alt wc-gradient wc-orange">
	<div class="wc-body">
		<p class="wc-alert">
...
#wl-coupons.wc-orange .wc-label {
	background: #d35400;
}

#wl-coupons.wc-orange .wc-body {}

#wl-coupons.wc-orange .wc-alert {}

#wl-coupons.wc-orange .wc-form {}

#wl-coupons.wc-orange .wishlist-coupon-code {}

#wl-coupons.wc-orange .wishlist-coupon-btn-apply {
	background: #d35400;
}

#wl-coupons.wc-orange .wc-footer {}

#wl-coupons.wc-orange .wishlist-coupon-btn-pay {
	background: #d35400;
}
...
/*ORANGE*/
#wl-coupons.wc-orange.wc-gradient .wc-label,
#wl-coupons.wc-orange.wc-gradient .wishlist-coupon-btn-pay,
#wl-coupons.wc-orange.wc-gradient .wishlist-coupon-btn-apply {
	background: rgb(230,126,34); /* Old browsers */
	/* IE9 SVG, needs conditional override of 'filter' to 'none' */
	background: url(data:image/svg+xml;base64,);
	background: -moz-linear-gradient(top,  rgba(230,126,34,1) 0%, rgba(211,84,0,1) 100%); /* FF3.6+ */
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,rgba(230,126,34,1)), color-stop(100%,rgba(211,84,0,1))); /* Chrome,Safari4+ */
	background: -webkit-linear-gradient(top,  rgba(230,126,34,1) 0%,rgba(211,84,0,1) 100%); /* Chrome10+,Safari5.1+ */
	background: -o-linear-gradient(top,  rgba(230,126,34,1) 0%,rgba(211,84,0,1) 100%); /* Opera 11.10+ */
	background: -ms-linear-gradient(top,  rgba(230,126,34,1) 0%,rgba(211,84,0,1) 100%); /* IE10+ */
	background: linear-gradient(to bottom,  rgba(230,126,34,1) 0%,rgba(211,84,0,1) 100%); /* W3C */
...
#wl-coupons.wc-orange.wc-gradient .wishlist-coupon-btn-pay:hover,
#wl-coupons.wc-orange.wc-gradient .wishlist-coupon-btn-apply:hover {
	background: #d35400;
}
...
/*ORANGE*/
#wl-coupons.wc-horizontal.wc-orange .wc-label,
#wl-coupons.wc-alt.wc-orange .wc-label { color: #d35400;}
#wl-coupons.wc-horizontal.wc-orange,
#wl-coupons.wc-alt.wc-orange { border-top: 2px solid #d35400;}
