<!--
name: Blackout Horizontal
screenshot: blackout-horizontal.png
default: yes
-->

<div id="wl-coupons" class="wishlist-coupon-promotion rounded drop-shadow wc-horizontal wc-gradient wc-bo">
	<div class="wc-body">
		<p class="wc-alert">
...
/*BLACKOUT*/
#wl-coupons.wc-horizontal.wc-bo .wc-label { color: #fff;}
#wl-coupons.wc-horizontal.wc-bo { border-top: 2px solid #000;}
</style>
