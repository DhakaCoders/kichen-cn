<!--
name: Midnight Alternative
screenshot: midnight-alt.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded wc-alt wc-gradient wc-mn">
	<div class="wc-body">
		<p class="wc-alert">
...
/*MIDNIGHT*/
#wl-coupons.wc-horizontal.wc-mn,
#wl-coupons.wc-alt.wc-mn { border-top: 2px solid #7f8c8d;}
