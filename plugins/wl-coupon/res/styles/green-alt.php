...
screenshot: green-alt.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded wc-alt wc-gradient wc-green">
	<div class="wc-body">
		<p class="wc-alert">
...
#wl-coupons.wc-green .wc-label {
	background: #16a085;
}

#wl-coupons.wc-green .wc-body {}

#wl-coupons.wc-green .wc-alert {}

#wl-coupons.wc-green .wc-form {}

#wl-coupons.wc-green .wishlist-coupon-code {}

#wl-coupons.wc-green .wishlist-coupon-btn-apply {
	background: #16a085;
}

#wl-coupons.wc-green .wc-footer {}

#wl-coupons.wc-green .wishlist-coupon-btn-pay {
	background: #16a085;
}
...
/*GREEN*/
#wl-coupons.wc-green.wc-gradient .wc-label,
#wl-coupons.wc-green.wc-gradient .wishlist-coupon-btn-pay,
#wl-coupons.wc-green.wc-gradient .wishlist-coupon-btn-apply {
	...
	background: -moz-linear-gradient(top,  rgba(26,188,156,1) 0%, rgba(22,160,133,1) 100%); /* FF3.6+ */
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,rgba(26,188,156,1)), color-stop(100%,rgba(22,160,133,1))); /* Chrome,Safari4+ */
	background: -webkit-linear-gradient(top,  rgba(26,188,156,1) 0%,rgba(22,160,133,1) 100%); /* Chrome10+,Safari5.1+ */
	background: -o-linear-gradient(top,  rgba(26,188,156,1) 0%,rgba(22,160,133,1) 100%); /* Opera 11.10+ */
	background: -ms-linear-gradient(top,  rgba(26,188,156,1) 0%,rgba(22,160,133,1) 100%); /* IE10+ */
	background: linear-gradient(to bottom,  rgba(26,188,156,1) 0%,rgba(22,160,133,1) 100%); /* W3C */
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#1abc9c', endColorstr='#16a085',GradientType=0 ); /* IE6-8 */
...
#wl-coupons.wc-green.wc-gradient .wishlist-coupon-btn-pay:hover,
#wl-coupons.wc-green.wc-gradient .wishlist-coupon-btn-apply:hover {
	background: #16a085;

}

#wl-coupons.wc-green.wc-alt.wc-gradient .wishlist-coupon-btn-pay {
	height: auto;
	padding: 15px;
}
...
/*GREEN*/
#wl-coupons.wc-horizontal.wc-green .wc-label,
#wl-coupons.wc-alt.wc-green .wc-label { color: #16a085;}
#wl-coupons.wc-horizontal.wc-green,
#wl-coupons.wc-alt.wc-green { border-top: 2px solid #16a085;}
