...
screenshot: red-alt.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded wc-alt wc-gradient wc-red">
	<div class="wc-body">
		<p class="wc-alert">
...
/*RED ALT Version*/
#wl-coupons.wc-horizontal.wc-red .wc-label,
#wl-coupons.wc-alt.wc-red .wc-label { color: #c0392b;}
#wl-coupons.wc-horizontal.wc-red,
#wl-coupons.wc-alt.wc-red { border-top: 2px solid #c0392b;}

#wl-coupons.wc-red.wc-alt.wc-gradient .wishlist-coupon-btn-pay {
	height: auto;
	padding: 15px;
}
