...
screenshot: dark-alt.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded wc-alt wc-gradient wc-dark">
	<div class="wc-body">
		<p class="wc-alert">
...
/*DARK*/
#wl-coupons.wc-horizontal.wc-dark .wc-label,
#wl-coupons.wc-alt.wc-dark .wc-label { color: #DE6032;}
#wl-coupons.wc-horizontal.wc-dark,
#wl-coupons.wc-alt.wc-dark { border-top: 2px solid #000;}
