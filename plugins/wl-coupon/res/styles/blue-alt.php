...
screenshot: blue-alt.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded wc-alt wc-gradient wc-blue">
	<div class="wc-body">
		<p class="wc-alert">
...
/*BLUE*/
#wl-coupons.wc-horizontal.wc-blue .wc-label,
#wl-coupons.wc-alt.wc-blue .wc-label { color: #2980b9;}
#wl-coupons.wc-horizontal.wc-blue,
#wl-coupons.wc-alt.wc-blue { border-top: 2px solid #2980b9;}
