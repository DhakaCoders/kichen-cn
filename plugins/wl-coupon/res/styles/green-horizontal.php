<!--
name: Green Horizontal
screenshot: green-horizontal.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded drop-shadow wc-horizontal wc-gradient wc-green">
	<div class="wc-body">
		<p class="wc-alert">
...
/*GREEN*/
#wl-coupons.wc-horizontal.wc-green .wc-label { color: #16a085;}
#wl-coupons.wc-horizontal.wc-green { border-top: 2px solid #16a085;}
