...
screenshot: dark-horizontal.png
default: yes
-->
<div id="wl-coupons" class="wishlist-coupon-promotion rounded drop-shadow wc-horizontal wc-gradient wc-dark">
	<div class="wc-body">
		<p class="wc-alert">
...
/*DARK*/
#wl-coupons.wc-horizontal.wc-dark { border-top: 2px solid #000;}
