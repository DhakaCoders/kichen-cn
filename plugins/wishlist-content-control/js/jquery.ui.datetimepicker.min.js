    ...
    $.extend(Datetimepicker.prototype, {
        ...
        _updateDatepicker: function(inst) {
			...
			.find('button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a')
				.bind('mouseout', function() {
				    $(this).removeClass('ui-state-hover');
                                    if($(this).hasClass('ui-state-active')){$(this).addClass('ui-state-active');} 
				...
				.bind('mousedown', function() {
                                        $(this).removeClass('ui-state-hover');
                                        $(this).parents('.ui-datepicker-calendar').find('a').removeClass('ui-state-active');
            ...
            if (inst.currentHour != undefined) {
             ...
             //so that the timepicker will not refresh
        ...
        */
        ...
        /* Action for selecting a time. */
        _selectTime: function(id) {
            var target = $(id);
            var inst = this._getInst(target[0]);
            var d1 = new Date(target.val());
            inst.selectedDay = inst.currentDay = d1.getDate();
            inst.selectedMonth = inst.currentMonth = d1.getMonth();
            inst.selectedYear = inst.currentYear = d1.getFullYear();
            ...
            for (var row = 0; row < numMonths[0]; row++) {
                ...
                for (var col = 0; col < numMonths[1]; col++) {
					...
					'</div>';
                      //add time here
                // Hour Drop Down
                calender += '<div style="text-align:center;padding-top:4px;" >Time <select onchange="DP_jQuery_' +dpuuid +'.datetimepicker._selectTime(\'#' +inst.id+'\');return false;" id="DP_jQuery_Hour_' + dpuuid + '">';
                for (i = 1; i < 13; i++) {
                    calender += '<option value="' + i + '"';
                ...
                var MinuteHTML;
                MinuteHTML = '';
                MinuteHTML += '&nbsp;: <select onchange="DP_jQuery_' +dpuuid +'.datetimepicker._selectTime(\'#' +inst.id+'\');return false;" id="DP_jQuery_Minute_' + dpuuid + '">';
                ...
                //AM/PM drop Down
                calender += ' <select onchange="DP_jQuery_' +dpuuid +'.datetimepicker._selectTime(\'#' +inst.id+'\');return false;" id="DP_jQuery_AMPM_' + dpuuid + '"><option value="AM"';
                if (inst.currentAMPM == "AM")
                    calender += ' selected ';
                calender += '>AM</option><option value="PM"';
                if (inst.currentAMPM == "PM")
                    calender += ' selected ';
                calender += '>PM</option></select><div>';
