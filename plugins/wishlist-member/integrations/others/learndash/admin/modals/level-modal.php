										...
										<div role="tabpanel" class="tab-pane active" id="<?php echo $level_id; ?>-<?php echo $key; ?>-learndash-course">
											<div class="col-md-12">
												<div class="form-group">
													...
													<select class="wlm-select learndash-courses-select" multiple="multiple" data-placeholder="Select Courses..." style="width:100%" name="learndash_settings[level][<?php echo $level_id; ?>][<?php echo $key; ?>][apply_course][]"></select>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label><?php _e( 'Remove from Course', 'wishlist-member' ); ?></label>
													<select class="wlm-select learndash-courses-select" multiple="multiple" data-placeholder="Select Courses..." style="width:100%" name="learndash_settings[level][<?php echo $level_id; ?>][<?php echo $key; ?>][remove_course][]"></select>
												</div>
											</div>
										</div>
										<div role="tabpanel" class="tab-pane" id="<?php echo $level_id; ?>-<?php echo $key; ?>-learndash-group">
											<div class="col-md-12">
												<div class="form-group">
													...
													<select class="wlm-select learndash-groups-select" multiple="multiple" data-placeholder="Select Groups..." style="width:100%" name="learndash_settings[level][<?php echo $level_id; ?>][<?php echo $key; ?>][apply_group][]"></select>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label><?php _e( 'Remove from Group', 'wishlist-member' ); ?></label>
													<select class="wlm-select learndash-groups-select" multiple="multiple" data-placeholder="Select Groups..." style="width:100%" name="learndash_settings[level][<?php echo $level_id; ?>][<?php echo $key; ?>][remove_group][]"></select>
												</div>
											</div>
										</div>
								</div>
