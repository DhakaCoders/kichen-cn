				...
				<div class="row tab-pane <?php echo $key=='add' ? 'active in':''; ?> px-2" id="elearncommerce-when-<?php echo $key; ?>-<?php echo $level_id; ?>">
					<div class="col-md-12">
						<div class="form-group">
							...
							<select class="wlm-select elearncommerce-courses-select" multiple="multiple" data-placeholder="Select Courses..." style="width:100%" name="elearncommerce_settings[level][<?php echo $level_id; ?>][<?php echo $key; ?>][apply_course][]"></select>
						</div>
					</div>
				</div>
			<?php endforeach; ?>
