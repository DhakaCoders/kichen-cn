	...
	<div class="body">
		<div class="row">
			<template class="wlm3-form-group">
				{
					label : '<?php _e( 'Subscription Form Post URL', 'wishlist-member' ); ?>',
					type : 'text',
					name : 'postURL[<?php echo $level->id; ?>]',
					column : 'col-12',
					'data-mirror-value' : '#generic2-lists-<?php echo $level->id; ?>',
			...
			<template class="wlm3-form-group">
				{
					...
					type  : 'checkbox',
					column : 'col-12',
					'data-mirror-value' : '#generic2-unsubscribe-<?php echo $level->id; ?>',
				}
			</template>
		</div>
	</div>
