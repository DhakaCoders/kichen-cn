		...
		<div class="row">
			<div class="col-md-12">	
				<ul class="nav nav-tabs">
					<li class="active nav-item"><a class="nav-link" data-toggle="tab" href="#infusionsoft-ar-when-added-<?php echo $level->id; ?>">When Added</a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#infusionsoft-ar-when-removed-<?php echo $level->id; ?>">When Removed</a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#infusionsoft-ar-when-cancelled-<?php echo $level->id; ?>">When Cancelled</a></li>
				</ul>
			</div>
		</div>
