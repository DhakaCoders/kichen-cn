...
<div class="sidebar">
  <div class="ap-side">
    <a href="#" class="wlm-brand d-none d-sm-block <?php echo $menu_on_top; ?>" id="wlm3-hamburger-toggle">
      <img src="<?php echo $this->pluginURL3; ?>/ui/images/wlm-logo.png" alt="">
      <span class="logo-text"><?php _e( 'WishList Member', 'wishlist-member' ); ?></span>
    </a>
<!--     <a href="" class="wlm-brand"><img src="<?php echo $this->pluginURL3; ?>/ui/images/wlm-logo.png" alt=""><span class="pt-2">WishList Member</span></a>
