	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text" class="form-control" value="<?php echo $wpm_useraddress['company']; ?>" name="wpm_useraddress[company]"  placeholder="Company" />
	    	</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="form-group no-margin">
				...
				<input type="text" class="form-control" value="<?php echo $wpm_useraddress['address1']; ?>" name="wpm_useraddress[address1]"  placeholder="Street Address" />
	    	</div>
			<div class="form-group">
	    		<label class="d-md-none d-sm-none" for="">&nbsp;</label>
				<input type="text" class="form-control" value="<?php echo $wpm_useraddress['address2']; ?>" name="wpm_useraddress[address2]"  placeholder="Street Address 2" />
	    	</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-6 col-sm-6 col-xs-6">
			<div class="form-group">
				...
				<input type="text" class="form-control" value="<?php echo $wpm_useraddress['city']; ?>" name="wpm_useraddress[city]"  placeholder="City/Town" />
	    	</div>
		</div>
		<div class="col-md-6 col-sm-6 col-xs-6">
			<div class="form-group">
	    		<label for=""><?php _e( 'State/Province', 'wishlist-member' ); ?></label>
				<input type="text" class="form-control" value="<?php echo $wpm_useraddress['state']; ?>" name="wpm_useraddress[state]"  placeholder="State/Province" />
	    	</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-md-6 col-sm-6 col-xs-6">
			<div class="form-group mb-sm-1">
				...
				<input type="text" class="form-control" value="<?php echo $wpm_useraddress['zip']; ?>" name="wpm_useraddress[zip]"  placeholder="Zip/Postal Code" />
	    	</div>
		</div>
	</div>
</div>
						...
						<div role="tabpanel" class="tab-pane <?php echo $ptype == 'post' ? 'active' : ''; ?>" id="<?php echo $ptype; ?>">
							<div class="table-wrapper table-responsive" style="overflow: scroll; max-height: 247px;">
								<table class="table table-condensed table-striped">
									<tbody class="<?php echo $ptype; ?>-holder">
										<?php if ( count($p) > 0 ) : ?>
									 		<?php foreach( $p as $post ): ?>
										 		<tr class="button-hover">
										 			<td class="post-title"><?php echo $post->post_title; ?></td>
										 			<td width="10%" class="no-padding">
														<div class="btn-group-action">
															<a href="#" post-id="<?php echo $post->ID; ?>" class="btn remove-ppp-btn -del-btn"><span class="wlm-icons md-24 -icon-only">delete</span></a>
														</div>
										 			</td>
										 		</tr>
									 		<?php endforeach; ?>
	...
	<div class="row">
		<div class="col-md-12">
			 <div class="form-group -url-group">
				...
				<input type="text" value="<?php echo $profileuser->wlm_feed_url; ?>" class="form-control copyable" readonly="readonly" tooltip_size="md" data-lpignore="true">
			</div>
		</div>
	</div>
	<div class="row">
		...
		<?php if( $cnt == 1 ) echo '<div class="row">'; ?>
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<?php elseif ( $value['type'] == "textarea" ): ?>
					<div class="form-group">
			    		<label for=""><?php echo $value['label']; ?></label>
			    		<textarea class="form-control" name="customfields[<?php echo $value['attributes']['name']; ?>]"><?php echo $value['attributes']['value']; ?></textarea>
			    	</div>
				...
				<?php else: ?>
					<div class="form-group">
						...
						<input type="text" class="form-control" value="<?php echo $value['attributes']['value']; ?>" name="customfields[<?php echo $value['attributes']['name']; ?>]" />
			    	</div>
			    <?php endif; ?>
			</div>
