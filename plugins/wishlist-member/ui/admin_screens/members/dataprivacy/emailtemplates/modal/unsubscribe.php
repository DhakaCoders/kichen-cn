<div
	...
	<div class="body">
		<div class="row">
			<div class="col-md-12">
				<template class="wlm3-form-group">
					{
						label : '<?php _e( 'Notify a member when they are unsubscribed from Email Broadcast mailing list', 'wishlist-member' ); ?>',
						name : 'member_unsub_notification',
						checked_value : '<?php echo $this->GetOption('member_unsub_notification'); ?>',
						type : 'toggle-switch',
						value: 1,
						uncheck_value: 0,
					}
		...
		<div class="row">
			...
			<div class="col-md-12">
				<button class="btn -default -condensed email-reset-button" data-target="member_unsub_notification"><?php _e( 'Reset to Default', 'wishlist-member' ); ?></button>
				<template class="wlm3-form-group">
					{
						type : 'select',
