...
<div class="table-wrapper -special table-responsive">
	<table id="members-table" class="table table-condensed">
			<thead>
				...
				<?php if ( $wp_user_search->total_users ) : ?>
					<?php foreach ((array) $wp_user_search->results AS $uid): $user = $this->Get_UserData($uid); ?>
						...
						<tbody class="outer-tbody button-hover">
							...
							<!-- Levels Details -->
							<tr class="level-details-tr level-details-tr-<?php echo $user->ID ?>">
...
<div id="add-level-modal" data-id="add-level-modal" data-label="add_level_modal_label" data-title="Add Member to Level" data-classes="modal-lg" style="display:none">
	<div class="body">
		<div class="form-group col-md-12 membership-level-select">
			...
			<select class="form-control wlm-levels" multiple="multiple" name="wlm_levels[]" placeholder="--Select Level--" style="width: 100%" required>
	...
	<div class="body">
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6">
				<div class="form-group">
					<label for=""><?php _e( 'Membership Level', 'wishlist-member' ); ?></label>
					<select class="form-control wlm-levels" name="wpm_id" id="" style="width: 100%" required="true">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-check pl-0">
					...
					<input type="checkbox" class="form-check-input" name="send_welcome_email" value="1" <?php echo $this->GetOption('send_welcome_email') ? 'checked' : ''; ?>>
					<span class="marker checkmark"></span>
					<span class="text-content"><?php _e( 'Send New Member Email Notification', 'wishlist-member' ); ?></span>
				</div>
			</div>
		</div>
		<input type="hidden" name="action" value="admin_actions" />
...
<div id="edit-user-modal" data-id="edit-user-modal" data-label="edit_user_modal_label" data-title="Edit Member: Jen Grey&nbsp;|&nbsp;jgrey&nbsp;|&nbsp;jgrey@gmail.com" data-classes="modal-lg" style="display:none">
	<div class="body">
		<ul class="nav nav-tabs" role="tablist">
