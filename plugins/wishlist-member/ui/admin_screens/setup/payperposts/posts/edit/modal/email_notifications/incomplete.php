<div class="incomplete -holder">
	<div class="row">
		<div class="col-md-12">
			...
			label : '<?php _e( 'Enable', 'wishlist-member' ); ?>', name : 'incomplete_notification',
			type : 'toggle-switch', value: 1, uncheck_value: 0, 
			tooltip : '<?php _e( 'The Incomplete Registration Email will be sent to those who do not complete the Registration Form during the registration process. This email includes a link the Member can use to complete the registration process.', 'wishlist-member' ); ?>',
			tooltip_size: 'lg'
			}</template>
		</div>
		<div class="col-md-12">
