...
if( !$post ) {
	...
	$pagination = new WishListMember3_Pagination( count( $ppps ), $pagination_size, wlm_arrval( $_GET, 'offset' ), 'offset', sprintf( '%s&search=%s&filter=%s', $admin_page, wlm_arrval( $_GET, 'search' ), wlm_arrval( $_GET, 'filter' ) ), $this->pagination_items );
