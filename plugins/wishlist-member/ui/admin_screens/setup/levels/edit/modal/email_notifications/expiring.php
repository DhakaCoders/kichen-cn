<div class="expiring -holder">
	<ul class="nav nav-tabs" role="tablist">
		<li class="nav-item" role="presentation"><a class="nav-link" href="#expiring_notification_user" role="tab" data-toggle="tab"><?php _e( 'User Notification', 'wishlist-member' ); ?></a></li>
		<li class="nav-item" role="presentation"><a class="nav-link" href="#expiring_notification_admin" role="tab" data-toggle="tab"><?php _e( 'Admin Notification', 'wishlist-member' ); ?></a></li>
	</ul>
		...
		<div role="tabpanel" class="tab-pane" id="expiring_notification_admin">
			<div class="row">
				<div class="col-md-12">
					...
					<template class="wlm3-form-group">{
					label : '<?php _e( 'Enable', 'wishlist-member' ); ?>', name : 'expiring_notification_admin',
					type : 'toggle-switch', value: 1, uncheck_value: 0,
					tooltip : '<?php _e( 'The New Member Registration Email will automatically be sent to the site admin when a new Member registers for a Membership Level.', 'wishlist-member' ); ?>'
					}</template>
		...
		<div role="tabpanel" class="tab-pane" id="expiring_notification_user">
			<div class="row">
				<div class="col-md-12">
					...
					<template class="wlm3-form-group">{
					label : '<?php _e( 'Enable', 'wishlist-member' ); ?>', name : 'expiring_notification_user',
					type : 'toggle-switch', value: 1, uncheck_value: 0,
					tooltip : '<?php _e( 'The New Member Registration Email will automatically be sent to all newly registered Members immediately after the Registration Form has been filled out. It will also be sent to a member if their account is created manually in the Members tab. This email will not be sent if any of the \\"Require Members to Confirm Email\\" or \\"Require Admin Approval For Shopping Cart Integrations\\" or \\"Require Admin Approval For Free Registrations\\" settings are enabled in the Setup > Levels > Level Name > Requirements section.', 'wishlist-member' ); ?>',
					tooltip_size: 'xxl'					
					}</template>
					<br style="clear:both"><hr style="margin-top:0">
				</div>
