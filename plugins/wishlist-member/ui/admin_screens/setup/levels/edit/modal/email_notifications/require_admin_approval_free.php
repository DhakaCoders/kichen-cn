<div class="requireadminapproval-free -holder">
	<ul class="nav nav-tabs" role="tablist">
		<li class="nav-item" role="presentation"><a class="nav-link" href="#requireadminapproval_free_notification_admin" role="tab" data-toggle="tab"><?php _e( 'Notification to Admin', 'wishlist-member' ); ?></a></li>
		<li class="nav-item" role="presentation"><a class="nav-link" href="#requireadminapproval_free_notification_user1" role="tab" data-toggle="tab"><?php _e( 'User Awaiting Approval', 'wishlist-member' ); ?></a></li>
		<li class="nav-item" role="presentation"><a class="nav-link" href="#requireadminapproval_free_notification_user2" role="tab" data-toggle="tab"><?php _e( 'User Approved', 'wishlist-member' ); ?></a></li>
	</ul>
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane" id="requireadminapproval_free_notification_admin">
			<div class="row">
				<div class="col-md-12">
					...
					label : '<?php _e( 'Enable', 'wishlist-member' ); ?>', name : 'require_admin_approval_free_notification_admin',
			...
			<div class="row">
				...
				<div class="col-md-12">
					<button class="btn -default -condensed email-reset-button" data-target="require_admin_approval_free_admin"><?php _e( 'Reset to Global Default Message', 'wishlist-member' ); ?></button>
					<template class="wlm3-form-group">{
						type : 'select',
		...
		<div role="tabpanel" class="tab-pane" id="requireadminapproval_free_notification_user1">
			<div class="row">
				<div class="col-md-12">
					<template class="wlm3-form-group">{
					label : '<?php _e( 'Enable', 'wishlist-member' ); ?>', name : 'require_admin_approval_free_notification_user1',
					type : 'toggle-switch', value: 1, uncheck_value: 0,
					}</template>
					<hr>
				</div>
		...
		<div role="tabpanel" class="tab-pane" id="requireadminapproval_free_notification_user2">
			<div class="row">
				<div class="col-md-12">
					<template class="wlm3-form-group">{
					label : '<?php _e( 'Enable', 'wishlist-member' ); ?>', name : 'require_admin_approval_free_notification_user2',
					type : 'toggle-switch', value: 1, uncheck_value: 0,
					}</template>
					<hr>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<button class="btn -default -condensed email-reset-button" data-target="require_admin_approval_free_user2"><?php _e( 'Reset to Global Default Message', 'wishlist-member' ); ?></button>
					<template class="wlm3-form-group">{
						type : 'select',
						column : 'col-md-5 pull-right no-padding no-margin',
						'data-placeholder' : '<?php _e( 'Insert Merge Codes', 'wishlist-member' ); ?>',
