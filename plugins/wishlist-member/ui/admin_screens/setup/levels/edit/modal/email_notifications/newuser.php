<div class="newuser -holder">
	<ul class="nav nav-tabs" role="tablist">
		<li class="nav-item" role="presentation"><a class="nav-link" href="#newuser_notification_user" role="tab" data-toggle="tab"><?php _e( 'User Notification', 'wishlist-member' ); ?></a></li>
		<li class="nav-item" role="presentation"><a class="nav-link" href="#newuser_notification_admin" role="tab" data-toggle="tab"><?php _e( 'Admin Notification', 'wishlist-member' ); ?></a></li>
	</ul>
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane" id="newuser_notification_admin">
			<div class="row">
				<div class="col-md-12">
					...
					label : '<?php _e( 'Enabling this will send a message to the admin after a member registers for this membership level', 'wishlist-member' ); ?>', name : 'newuser_notification_admin',
			...
			<div class="row">
				...
				<div class="col-md-12">
					<button class="btn -default -condensed email-reset-button" data-target="newuser_admin"><?php _e( 'Reset to Global Default Message', 'wishlist-member' ); ?></button>
					<template class="wlm3-form-group">{
						type : 'select',
		...
		<div role="tabpanel" class="tab-pane" id="newuser_notification_user">
			<div class="row">
				<div class="col-md-12">
					<template class="wlm3-form-group">{
					label : '<?php _e( 'Enabling this will send a message to the member after they register for this membership level', 'wishlist-member' ); ?>', name : 'newuser_notification_user',
					type : 'toggle-switch', value: 1, uncheck_value: 0,
					}</template>
					<hr>
				</div>
