	...
	<div class="page-header">
		<div class="row">
			<div class="col-md-9 col-sm-9 col-xs-8">
				<h2 class="page-title">
					<?php _e( 'Membership Levels','wishlist-member' ); ?>
		...
		<div class="col-md-12">
			<div class="table-wrapper table-responsive">
				<table id="levels-list-table" class="table table-striped table-condensed d-none">
					...
					<thead>
						<tr>
							<th><?php _e( 'Level Name','wishlist-member' ); ?></th>
...
<tr data-id="<%- level.id %>" data-sort="<%- level.levelOrder %>" data-count="<%- parseInt('0' + levelcount) %>" class="button-hover">
	...
	<td>
		<a class="edit-level -edit-btn" href="#levels_access-<%- level.id %>" target="_parent"><%- level.name %></a>
	</td>
	...
	<td class="text-center" style="white-space: nowrap">
		<div class="btn-group-action">
			<a href="#levels_access-<%- level.id %>" title="Edit Membership Level" class="btn -icon-only -edit-btn" target="_parent">
