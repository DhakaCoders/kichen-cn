					...
					<tr class="more-details -top-level">
						...
						<th style="width: 20%;" class="pt-0">
							<a class="level-collapse py-0 <?php echo count($content_schedules) ? '' : 'd-none'; ?>" href="#" data-target=".collapse<?php echo $item->ID; ?>" data-userid="<?php echo $item->ID; ?>">
								...
								<span class="collapse<?php echo $item->ID; ?> levelheader text <?php echo $icollapse1; ?>"><?php _e('Schedules', 'wishlist-member'); ?></span>
								<span class="collapse<?php echo $item->ID; ?> thelevels <?php echo $icollapse2; ?> text"><?php _e('Schedules', 'wishlist-member'); ?></span>
							</a>
						</th>
						<th class="p-0">
						</th>
