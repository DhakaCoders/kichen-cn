<div class="newuser -holder">
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane" id="newuser_notification_admin">
			<div class="row">
				<?php printf( $enable_as_default, 'newuser_notification_admin' ); ?>
				...
				<div class="col-md-12">
					<button class="btn -default -condensed email-reset-button" data-target="newuser_admin"><?php _e( 'Reset to Original Message', 'wishlist-member' ); ?></button>
					<template class="wlm3-form-group">{
						type : 'select',
		...
		<div role="tabpanel" class="tab-pane" id="newuser_notification_user">
			<div class="row">
				<?php printf( $enable_as_default, 'newuser_notification_user' ); ?>
				<template class="wlm3-form-group">{
					addon_left : 'Subject',
					group_class : '-label-addon mb-2',
					type : 'text',
