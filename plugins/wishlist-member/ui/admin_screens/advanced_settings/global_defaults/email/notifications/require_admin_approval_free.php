<div class="requireadminapproval-free -holder">
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane" id="requireadminapproval_free_notification_admin">
			<div class="row">
				<?php printf( $enable_as_default, 'require_admin_approval_free_notification_admin' ); ?>
				...
				<div class="col-md-12">
					<button class="btn -default -condensed email-reset-button" data-target="require_admin_approval_free_admin"><?php _e( 'Reset to Original Message', 'wishlist-member' ); ?></button>
					<template class="wlm3-form-group">{
						type : 'select',
		...
		<div role="tabpanel" class="tab-pane" id="requireadminapproval_free_notification_user1">
			<div class="row">
				<?php printf( $enable_as_default, 'require_admin_approval_free_notification_user1' ); ?>
				<template class="wlm3-form-group">{
					addon_left : 'Subject',
					group_class : '-label-addon mb-2',
					type : 'text',
		...
		<div role="tabpanel" class="tab-pane" id="requireadminapproval_free_notification_user2">
			<div class="row">
				<?php printf( $enable_as_default, 'require_admin_approval_free_notification_user2' ); ?>
				<template class="wlm3-form-group">{
					addon_left : 'Subject',
					group_class : '-label-addon mb-2',
					type : 'text',
				...
				<div class="col-md-12">
					<button class="btn -default -condensed email-reset-button" data-target="require_admin_approval_free_user2"><?php _e( 'Reset to Original Message', 'wishlist-member' ); ?></button>
					<template class="wlm3-form-group">{
						type : 'select',
						column : 'col-md-5 pull-right no-padding no-margin',
						'data-placeholder' : '<?php _e( 'Insert Merge Codes', 'wishlist-member' ); ?>',
