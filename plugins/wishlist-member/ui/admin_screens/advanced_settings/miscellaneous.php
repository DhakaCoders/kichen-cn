...
<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-md-12">
			<label for="">
				Affiliate ID
				<?php $this->tooltip(__('A WishList Products Affiliate ID can be added to track sales that originate from clicks of the "Powered by WishList Member - Membership Software" link in the site footer.', 'wishlist-member'), 'lg'); ?>
			</label>
			<div class="row">
