...
<?php
	...
	printf( "<script type='text/javascript'>\nwpm_regforms = %s\nwpm_regform_default = %s\nwpm_levels = %s\nwpm_used_forms = %s\n</script>\n", preg_replace( '/ style=\\\\".+?"/', '', json_encode( $registration_forms ) ), json_encode( $this->get_legacy_registration_form( $the_formid, '', true ) ), json_encode( $wpm_levels ), json_encode( $used_forms ) );
