				...
				<div class="pagination pull-right">
						...
						<div role="presentation" class="dropdown page-rows">
							...
							<ul class="dropdown-menu" id="menu1" aria-labelledby="drop-page">
								<?php foreach ( $this->pagination_items as $value ) : ?>
									<li><a target="_parent" href="<?php echo "?" .$this->QueryString() ."&howmany=" .$value; ?>"><?php echo $value; ?></a></li>
								<?php endforeach; ?>
							</ul>
						</div>
					</div>
					<?php if ( $perpage <= $emails_count ) : ?>
						<div class="arrows pull-right">
							<?php
							if ( $current_page <= 1 ) $previous_link = "?" .$this->QueryString() ."&offset=" .$total_pages;
							else $previous_link = "?" .$this->QueryString() ."&offset=" .($current_page-1);
							?>
							<a target="_parent" href="<?php echo $previous_link; ?>" class="wlm-icons">keyboard_arrow_left</a>
							<?php
							if ( $current_page < $total_pages ) $next_link = "?" .$this->QueryString() ."&offset=" .($current_page+1);
							else $next_link = "?" .$this->QueryString() ."&offset=1";
							?>
