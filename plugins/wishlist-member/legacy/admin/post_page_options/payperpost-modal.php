<div class="modal-box" id="wlm-ppp-modal" style="display: none">
	<div>
		...
		<form onsubmit="return false;" method="GET">
			<div class="wlm-search-box-container clearfix">
				<div class="wlm-search-box wlm-search-box-1">
					...
					</select><select style="width: 130px" class="form-control wlm-select" name="access" id="wlm_user_access">
						<option value="all"><?php _e( 'All Users', 'wishlist-member' ); ?></option>
						<option value="yes"><?php _e( 'Has Access', 'wishlist-member' ); ?></option>
						<option value="no"><?php _e( 'No Access', 'wishlist-member' ); ?></option>
					</select>
				</div>
				...
				<div class="wlm-search-box wlm-search-box-3">
					<input id="wlm3-ppp-search-button" class="wlm-btn" type="button" class="button-secondary" value="<?php _e( 'Search', 'wishlist-member' ); ?>" />
				</div>
			</div>
		</form>
		...
		<div id="wlm3-pagination" class="pagination pull-right -action-leveled" style="display: none">
			...
			<div class="count pull-left">
				<div role="presentation" class="dropdown page-rows">
					...
					<?php _e('of', 'wishlist-member'); ?> <span class="wlm3-pagination-total"></span>

					<a href="#_wlm3-ppp-prev" class="wlm-icon-arrow">
						<img style="color: #fff" src="<?php echo $this->pluginURL3; ?>/ui/images/baseline-keyboard_arrow_left-24px.svg" alt="">						
					</a>
					<a href="#_wlm3-ppp-next" class="wlm-icon-arrow">
						<img style="color: #fff" src="<?php echo $this->pluginURL3; ?>/ui/images/baseline-keyboard_arrow_right-24px.svg" alt="">						
					</a>
				</div>
			</div>
		</div>
		<table class="widefat" id="wlm_payperpost_table">
			...
			<thead>
				<tr>
					<th><?php _e('ID', 'wishlist-member'); ?></th>
					<th><?php _e('Name', 'wishlist-member'); ?></th>
					<th style="width: 120px"><?php _e('Username', 'wishlist-member'); ?></th>
					<th><?php _e('Email', 'wishlist-member'); ?></th>
					<th style="text-align: center"><?php _e('Access', 'wishlist-member'); ?></th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
