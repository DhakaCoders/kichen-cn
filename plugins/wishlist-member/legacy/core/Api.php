 ...
 * @revision $Rev: 5616 $
 * $LastChangedBy: mike $
 * $LastChangedDate: 2019-02-07 14:09:26 -0500 (Thu, 07 Feb 2019) $
 */
if (!class_exists('WLMAPI')) {
	define('WLMAPI_VERSION', '0.1.' . preg_replace('/[^0-9]/i', '', '$Rev: 5616 $'));
	 ...
	 */
	class WLMAPI {
		static $deprecated = 'WLMAPI is deprecated since WishList Member 3.0 and will be removed in version 3.1. Please migrate your code to use the newer API. More info at http://codex.wishlistproducts.com/tutorial-how-to-connect-to-the-wishlist-member-api/';
		...
		function GetOption($option, $dec = null) {
			trigger_error( self::$deprecated, E_USER_DEPRECATED );
