...
if(!class_exists('WLM3_ContentScheduler')){
	...
	class WLM3_ContentScheduler{
        ...
        function load_hooks(){
            ...
            add_filter('wlm_mergecodes', array(&$this, 'add_mergecode'),9999);
        ...
        function add_mergecode($mergecodes) {
            $mergecodes[] = array('title' => "Content Scheduler", 'value' => "", 'jsfunc'=>"wlmtnmcelbox_vars.show_scheduler_form_lightbox" );
            return $mergecodes;
        }
    	/**
                        ...
                        if($pid){
                            ...
                            if(isset($sched_content[$pid])){
                                ...
                                if ( $wlcc_sched_error_page == "url" ) {
                                    ...
                                    $url = $WishListMemberInstance->MagicPage() ."?sp=" ."scheduler";
                                }
                                if ( !$url ) $url = $this->MagicPage() ."?sp=" ."scheduler";
