...
abstract class Webhook
{
     ...
     * \WLMStripe\SignatureVerificationException if the signature verification
     ...
     * @return \WLMStripe\Event the Event instance
     * @throws \UnexpectedValueException if the payload is not valid JSON,
     * @throws \WLMStripe\Error\SignatureVerification if the verification fails.
     */
