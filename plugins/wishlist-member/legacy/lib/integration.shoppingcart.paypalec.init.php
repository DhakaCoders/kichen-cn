	...
	public function paypalec_shortcode_btns() {
		...
		if(in_array($pagenow, array('post.php', 'post-new.php', 'admin.php'))) {
			...
			if(is_array($products) && count($products)) {
				$WishListMemberInstance->IntegrationShortcodes[] = array('title' => __('PayPal Checkout Integration','wishlist-member') , 'value' => '', 'jsfunc' => 'wlmtnmcelbox_vars.show_paypalec_inserter_lightbox');
			}
		}
	}
