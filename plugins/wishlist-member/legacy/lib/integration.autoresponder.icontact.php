 ...
 * Version: $Id: integration.autoresponder.icontact.php 6461 2019-11-11 16:07:39Z mike $
 */
					...
					if (is_numeric($contactId)) {
						if ( is_array($listID) ) {
							foreach ($listID as $list) {
								$res = $this->contactListSubscription($icUserName, $icAppPassword, $icAppID, $icAcctID, $icFolderID, $contactId, $list, 'normal');
							}
						} else {
